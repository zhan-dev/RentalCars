table 50105 "RCars Posted Sales Line"
{
    Caption = 'Sales Line';
    ...
    fields
    {
        field(10; "Line Doc No."; Code[20])
        {
            ...
            TableRelation = "RCars Posted Sales Header"."Doc. No."; //автозамена ключа в доп. таблице при смене ключа в основной без потери данных
            Editable = false;
        }
